...
(function($) {
    $.fn.rotatingSlider = function(options) {
        var rotatingSlider = {
            init: function(el) {
                this.$slider = $(el);
                this.$slidesContainer = this.$slider.children("ul.slides"); //:not(.teamHead)
            ...
            beforeRotationStart: function(item) {
                item = this;
            ...
            beforeRotationEnd: function(item) {
                item = this;
                this.settings.beforeRotationEnd();
            },
            afterRotationEnd: function(item) {
                item = this;
...
$(function() {
    ...
    // $(".rotateSlideItem").append("<div class='teamHead'></div>")
